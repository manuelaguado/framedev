        ...
        <section class="wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-7">
                        <h3>Welcome To Clip-One</h3>
                        <p>
                            Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem.Donec pede justo, fringilla vel, aliquet nec, vulputate
                            eget, arcu.
                        </p>
                        <p>
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="progress-bars">
                            ...
                            <div class="progress">
                                <div class="progress-bar main-color animate-bar six-sec-ease-in-out" aria-valuetransitiongoal="60"></div>
                            </div>
                            <div class="progress-label">
                                <span>WordPress</span>
                            </div>
                            <div class="progress">
                                <div class="progress-bar main-color animate-bar six-sec-ease-in-out" aria-valuetransitiongoal="75"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-5">
                            ...
                            <ul class="team-list animate-group">
                                <li class="col-md-3 col-sm-6">
                                    <div class="thumbnail animate">
                                        <img src="<?=URL_PUBLIC?>frontend/images/team-1.jpg" alt="">
                                ...
                                <li class="col-md-3 col-sm-6">
                                    <div class="thumbnail animate">
                                        <img src="<?=URL_PUBLIC?>frontend/images/team-2.jpg" alt="">
                                ...
                                <li class="col-md-3 col-sm-6">
                                    <div class="thumbnail animate">
                                        <img src="<?=URL_PUBLIC?>frontend/images/team-3.jpg" alt="">
                                ...
                                <li class="col-md-3 col-sm-6">
                                    <div class="thumbnail animate">
                                        <img src="<?=URL_PUBLIC?>frontend/images/team-4.jpg" alt="">
