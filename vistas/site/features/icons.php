                    ...
                    <div class="col-sm-12">
                        <div class="widget">
                            ...
                            <div class="body icons">
                                <p>
                                    390 icons in pictographic font form. Add <code> .clip-* </code> class to <code> &lt;i&gt; </code> to display icon.
                                </p>
                                <div class="row">
                                    <div class="col-sm-3">
                                        <ul class="the-icons list-unstyled">
                                            <li>
                                                <i class="clip-settings"></i> clip-settings
                                            </li>
                                            <li>
                                                <i class="clip-camera"></i> clip-camera
                                            </li>
                                            <li>
                                                <i class="clip-tag"></i> clip-tag
                                            </li>
                                            <li>
                                                <i class="clip-bulb"></i> clip-bulb
                                            </li>
                                            <li>
                                                <i class="clip-paperplane"></i> clip-paperplane
                                            </li>
                                            <li>
                                                <i class="clip-bubble"></i> clip-bubble
                                            </li>
                                            <li>
                                                <i class="clip-banknote"></i> clip-banknote
                                            </li>
                                            <li>
                                                <i class="clip-music"></i> clip-music
                                            </li>
                                            <li>
                                                <i class="clip-data"></i> clip-data
                                            </li>
                                            <li>
                                                <i class="clip-t-shirt"></i> clip-t-shirt
                                            </li>
                                            <li>
                                                <i class="clip-clip"></i> clip-clip
                                            </li>
                                            <li>
                                                <i class="clip-calendar"></i> clip-calendar
                                            </li>
                                            <li>
                                                <i class="clip-vynil"></i> clip-vynil
                                            </li>
                                            <li>
                                                <i class="clip-truck"></i> clip-truck
                                            </li>
                                            <li>
                                                <i class="clip-note"></i> clip-note
                                            </li>
                                            <li>
                                                <i class="clip-world"></i> clip-world
                                            </li>
                                            <li>
                                                <i class="clip-key"></i> clip-key
                                            </li>
                                            <li>
                                                <i class="clip-pencil"></i> clip-pencil
                                            </li>
                                            <li>
                                                <i class="clip-pencil-2"></i> clip-pencil-2
                                            </li>
                                            <li>
                                                <i class="clip-images"></i> clip-images
                                            </li>
                                            <li>
                                                <i class="clip-images-2"></i> clip-images-2
                                            </li>
                                            <li>
                                                <i class="clip-list"></i> clip-list
                                            </li>
                                            <li>
                                                <i class="clip-earth"></i> clip-earth
                                            </li>
                                            <li>
                                                <i class="clip-pictures"></i> clip-pictures
                                            </li>
                                            <li>
                                                <i class="clip-cog"></i> clip-cog
                                            </li>
                                            <li>
                                                <i class="clip-home"></i> clip-home
                                            </li>
                                            <li>
                                                <i class="clip-home-2"></i> clip-home-2
                                            </li>
                                            <li>
                                                <i class="clip-pencil-3"></i> clip-pencil-3
                                            </li>
                                            <li>
                                                <i class="clip-images-3"></i> clip-images-3
                                            </li>
                                            <li>
                                                <i class="clip-eyedropper"></i> clip-eyedropper
                                            </li>
                                            <li>
                                                <i class="clip-droplet"></i> clip-droplet
                                            </li>
                                            <li>
                                                <i class="clip-droplet-2"></i> clip-droplet-2
                                            </li>
                                            <li>
                                                <i class="clip-image"></i> clip-image
                                            </li>
                                            <li>
                                                <i class="clip-music-2"></i> clip-music-2
                                            </li>
                                            <li>
                                                <i class="clip-camera-2"></i> clip-camera-2
                                            </li>
                                            <li>
                                                <i class="clip-camera-3"></i> clip-camera-3
                                            </li>
                                            <li>
                                                <i class="clip-headphones"></i> clip-headphones
                                            </li>
                                            <li>
                                                <i class="clip-headphones-2"></i> clip-headphones-2
                                            </li>
                                            <li>
                                                <i class="clip-gamepad"></i> clip-gamepad
                                            </li>
                                            <li>
                                                <i class="clip-podcast"></i> clip-podcast
                                            </li>
                                            <li>
                                                <i class="clip-connection"></i> clip-connection
                                            </li>
                                            <li>
                                                <i class="clip-connection-2"></i> clip-connection-2
                                            </li>
                                            <li>
                                                <i class="clip-new"></i> clip-new
                                            </li>
                                            <li>
                                                <i class="clip-book"></i> clip-book
                                            </li>
                                            <li>
                                                <i class="clip-file"></i> clip-file
                                            </li>
                                            <li>
                                                <i class="clip-file-2"></i> clip-file-2
                                            </li>
                                            <li>
                                                <i class="clip-file-plus"></i> clip-file-plus
                                            </li>
                                            <li>
                                                <i class="clip-file-minus"></i> clip-file-minus
                                            </li>
                                            <li>
                                                <i class="clip-file-check"></i> clip-file-check
                                            </li>
                                            <li>
                                                <i class="clip-file-remove"></i> clip-file-remove
                                            </li>
                                            <li>
                                                <i class="clip-file-3"></i> clip-file-3
                                            </li>
                                            <li>
                                                <i class="clip-copy"></i> clip-copy
                                            </li>
                                            <li>
                                                <i class="clip-copy-2"></i> clip-copy-2
                                            </li>
                                            <li>
                                                <i class="clip-copy-3"></i> clip-copy-3
                                            </li>
                                            <li>
                                                <i class="clip-copy-4"></i> clip-copy-4
                                            </li>
                                            <li>
                                                <i class="clip-paste"></i> clip-paste
                                            </li>
                                            <li>
                                                <i class="clip-stack"></i> clip-stack
                                            </li>
                                            <li>
                                                <i class="clip-stack-2"></i> clip-stack-2
                                            </li>
                                            <li>
                                                <i class="clip-folder"></i> clip-folder
                                            </li>
                                            <li>
                                                <i class="clip-folder-upload"></i> clip-folder-upload
                                            </li>
                                            <li>
                                                <i class="clip-folder-download"></i> clip-folder-download
                                            </li>
                                            <li>
                                                <i class="clip-folder-remove"></i> clip-folder-remove
                                            </li>
                                            <li>
                                                <i class="clip-folder-plus"></i> clip-folder-plus
                                            </li>
                                            <li>
                                                <i class="clip-folder-2"></i> clip-folder-2
                                            </li>
                                            <li>
                                                <i class="clip-folder-open"></i> clip-folder-open
                                            </li>
                                            <li>
                                                <i class="clip-cc"></i> clip-cc
                                            </li>
                                            <li>
                                                <i class="clip-tag-2"></i> clip-tag-2
                                            </li>
                                            <li>
                                                <i class="clip-barcode"></i> clip-barcode
                                            </li>
                                            <li>
                                                <i class="clip-cart"></i> clip-cart
                                            </li>
                                            <li>
                                                <i class="clip-phone-hang-up"></i> clip-phone-hang-up
                                            </li>
                                            <li>
                                                <i class="clip-phone"></i> clip-phone
                                            </li>
                                            <li>
                                                <i class="clip-phone-2"></i> clip-phone-2
                                            </li>
                                            <li>
                                                <i class="clip-location"></i> clip-location
                                            </li>
                                            <li>
                                                <i class="clip-compass"></i> clip-compass
                                            </li>
                                            <li>
                                                <i class="clip-map"></i> clip-map
                                            </li>
                                            <li>
                                                <i class="clip-alarm"></i> clip-alarm
                                            </li>
                                            <li>
                                                <i class="clip-clock"></i> clip-clock
                                            </li>
                                            <li>
                                                <i class="clip-history"></i> clip-history
                                            </li>
                                            <li>
                                                <i class="clip-stopwatch"></i> clip-stopwatch
                                            </li>
                                            <li>
                                                <i class="clip-keyboard"></i> clip-keyboard
                                            </li>
                                            <li>
                                                <i class="clip-screen"></i> clip-screen
                                            </li>
                                            <li>
                                                <i class="clip-laptop"></i> clip-laptop
                                            </li>
                                            <li>
                                                <i class="clip-mobile"></i> clip-mobile
                                            </li>
                                            <li>
                                                <i class="clip-mobile-2"></i> clip-mobile-2
                                            </li>
                                            <li>
                                                <i class="clip-tablet"></i> clip-tablet
                                            </li>
                                            <li>
                                                <i class="clip-mobile-3"></i> clip-mobile-3
                                            </li>
                                            <li>
                                                <i class="clip-rotate"></i> clip-rotate
                                            </li>
                                            <li>
                                                <i class="clip-rotate-2"></i> clip-rotate-2
                                            </li>
                                            <li>
                                                <i class="clip-redo"></i> clip-redo
                                            </li>
                                            <li>
                                                <i class="clip-undo"></i> clip-undo
                                            </li>
                                            <li>
                                                <i class="clip-database"></i> clip-database
                                            </li>
                                            <li>
                                                <i class="clip-bubble-2"></i> clip-bubble-2
                                            </li>
                                            <li>
                                                <i class="clip-bubbles"></i> clip-bubbles
                                            </li>
                                            <li>
                                                <i class="clip-bubble-3"></i> clip-bubble-3
                                            </li>
                                            <li>
                                                <i class="clip-bubble-4"></i> clip-bubble-4
                                            </li>
                                            <li>
                                                <i class="clip-bubble-dots"></i> clip-bubble-dots
                                            </li>
                                            <li>
                                                <i class="clip-bubble-dots-2"></i> clip-bubble-dots-2
                                            </li>
                                            <li>
                                                <i class="clip-bubbles-2"></i> clip-bubbles-2
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-3">
                                        <ul class="the-icons list-unstyled">
                                            <li>
                                                <i class="clip-bubbles-3"></i> clip-bubbles-3
                                            </li>
                                            <li>
                                                <i class="clip-user"></i> clip-user
                                            </li>
                                            <li>
                                                <i class="clip-users"></i> clip-users
                                            </li>
                                            <li>
                                                <i class="clip-user-plus"></i> clip-user-plus
                                            </li>
                                            <li>
                                                <i class="clip-user-minus"></i> clip-user-minus
                                            </li>
                                            <li>
                                                <i class="clip-user-cancel"></i> clip-user-cancel
                                            </li>
                                            <li>
                                                <i class="clip-user-block"></i> clip-user-block
                                            </li>
                                            <li>
                                                <i class="clip-user-2"></i> clip-user-2
                                            </li>
                                            <li>
                                                <i class="clip-user-3"></i> clip-user-3
                                            </li>
                                            <li>
                                                <i class="clip-users-2"></i> clip-users-2
                                            </li>
                                            <li>
                                                <i class="clip-user-4"></i> clip-user-4
                                            </li>
                                            <li>
                                                <i class="clip-user-5"></i> clip-user-5
                                            </li>
                                            <li>
                                                <i class="clip-hanger"></i> clip-hanger
                                            </li>
                                            <li>
                                                <i class="clip-quotes-left"></i> clip-quotes-left
                                            </li>
                                            <li>
                                                <i class="clip-quotes-right"></i> clip-quotes-right
                                            </li>
                                            <li>
                                                <i class="clip-busy"></i> clip-busy
                                            </li>
                                            <li>
                                                <i class="clip-spinner"></i> clip-spinner
                                            </li>
                                            <li>
                                                <i class="clip-spinner-2"></i> clip-spinner-2
                                            </li>
                                            <li>
                                                <i class="clip-spinner-3"></i> clip-spinner-3
                                            </li>
                                            <li>
                                                <i class="clip-spinner-4"></i> clip-spinner-4
                                            </li>
                                            <li>
                                                <i class="clip-spinner-5"></i> clip-spinner-5
                                            </li>
                                            <li>
                                                <i class="clip-spinner-6"></i> clip-spinner-6
                                            </li>
                                            <li>
                                                <i class="clip-microscope"></i> clip-microscope
                                            </li>
                                            <li>
                                                <i class="clip-search"></i> clip-search
                                            </li>
                                            <li>
                                                <i class="clip-zoom-in"></i> clip-zoom-in
                                            </li>
                                            <li>
                                                <i class="clip-zoom-out"></i> clip-zoom-out
                                            </li>
                                            <li>
                                                <i class="clip-search-2"></i> clip-search-2
                                            </li>
                                            <li>
                                                <i class="clip-key-2"></i> clip-key-2
                                            </li>
                                            <li>
                                                <i class="clip-key-3"></i> clip-key-3
                                            </li>
                                            <li>
                                                <i class="clip-keyhole"></i> clip-keyhole
                                            </li>
                                            <li>
                                                <i class="clip-wrench"></i> clip-wrench
                                            </li>
                                            <li>
                                                <i class="clip-wrench-2"></i> clip-wrench-2
                                            </li>
                                            <li>
                                                <i class="clip-cog-2"></i> clip-cog-2
                                            </li>
                                            <li>
                                                <i class="clip-cogs"></i> clip-cogs
                                            </li>
                                            <li>
                                                <i class="clip-health"></i> clip-health
                                            </li>
                                            <li>
                                                <i class="clip-stats"></i> clip-stats
                                            </li>
                                            <li>
                                                <i class="clip-inject"></i> clip-inject
                                            </li>
                                            <li>
                                                <i class="clip-bars"></i> clip-bars
                                            </li>
                                            <li>
                                                <i class="clip-rating"></i> clip-rating
                                            </li>
                                            <li>
                                                <i class="clip-rating-2"></i> clip-rating-2
                                            </li>
                                            <li>
                                                <i class="clip-rating-3"></i> clip-rating-3
                                            </li>
                                            <li>
                                                <i class="clip-leaf"></i> clip-leaf
                                            </li>
                                            <li>
                                                <i class="clip-balance"></i> clip-balance
                                            </li>
                                            <li>
                                                <i class="clip-atom"></i> clip-atom
                                            </li>
                                            <li>
                                                <i class="clip-atom-2"></i> clip-atom-2
                                            </li>
                                            <li>
                                                <i class="clip-lamp"></i> clip-lamp
                                            </li>
                                            <li>
                                                <i class="clip-remove"></i> clip-remove
                                            </li>
                                            <li>
                                                <i class="clip-puzzle"></i> clip-puzzle
                                            </li>
                                            <li>
                                                <i class="clip-puzzle-2"></i> clip-puzzle-2
                                            </li>
                                            <li>
                                                <i class="clip-cube"></i> clip-cube
                                            </li>
                                            <li>
                                                <i class="clip-cube-2"></i> clip-cube-2
                                            </li>
                                            <li>
                                                <i class="clip-pyramid"></i> clip-pyramid
                                            </li>
                                            <li>
                                                <i class="clip-puzzle-3"></i> clip-puzzle-3
                                            </li>
                                            <li>
                                                <i class="clip-puzzle-4"></i> clip-puzzle-4
                                            </li>
                                            <li>
                                                <i class="clip-clipboard"></i> clip-clipboard
                                            </li>
                                            <li>
                                                <i class="clip-switch"></i> clip-switch
                                            </li>
                                            <li>
                                                <i class="clip-list-2"></i> clip-list-2
                                            </li>
                                            <li>
                                                <i class="clip-list-3"></i> clip-list-3
                                            </li>
                                            <li>
                                                <i class="clip-list-4"></i> clip-list-4
                                            </li>
                                            <li>
                                                <i class="clip-list-5"></i> clip-list-5
                                            </li>
                                            <li>
                                                <i class="clip-list-6"></i> clip-list-6
                                            </li>
                                            <li>
                                                <i class="clip-grid"></i> clip-grid
                                            </li>
                                            <li>
                                                <i class="clip-grid-2"></i> clip-grid-2
                                            </li>
                                            <li>
                                                <i class="clip-grid-3"></i> clip-grid-3
                                            </li>
                                            <li>
                                                <i class="clip-grid-4"></i> clip-grid-4
                                            </li>
                                            <li>
                                                <i class="clip-grid-5"></i> clip-grid-5
                                            </li>
                                            <li>
                                                <i class="clip-grid-6"></i> clip-grid-6
                                            </li>
                                            <li>
                                                <i class="clip-menu"></i> clip-menu
                                            </li>
                                            <li>
                                                <i class="clip-menu-2"></i> clip-menu-2
                                            </li>
                                            <li>
                                                <i class="clip-circle-small"></i> clip-circle-small
                                            </li>
                                            <li>
                                                <i class="clip-tree"></i> clip-tree
                                            </li>
                                            <li>
                                                <i class="clip-menu-3"></i> clip-menu-3
                                            </li>
                                            <li>
                                                <i class="clip-menu-4"></i> clip-menu-4
                                            </li>
                                            <li>
                                                <i class="clip-cloud"></i> clip-cloud
                                            </li>
                                            <li>
                                                <i class="clip-download"></i> clip-download
                                            </li>
                                            <li>
                                                <i class="clip-upload"></i> clip-upload
                                            </li>
                                            <li>
                                                <i class="clip-download-2"></i> clip-download-2
                                            </li>
                                            <li>
                                                <i class="clip-upload-2"></i> clip-upload-2
                                            </li>
                                            <li>
                                                <i class="clip-globe"></i> clip-globe
                                            </li>
                                            <li>
                                                <i class="clip-upload-3"></i> clip-upload-3
                                            </li>
                                            <li>
                                                <i class="clip-download-3"></i> clip-download-3
                                            </li>
                                            <li>
                                                <i class="clip-earth-2"></i> clip-earth-2
                                            </li>
                                            <li>
                                                <i class="clip-network"></i> clip-network
                                            </li>
                                            <li>
                                                <i class="clip-link"></i> clip-link
                                            </li>
                                            <li>
                                                <i class="clip-link-2"></i> clip-link-2
                                            </li>
                                            <li>
                                                <i class="clip-link-3"></i> clip-link-3
                                            </li>
                                            <li>
                                                <i class="clip-link-4"></i> clip-link-4
                                            </li>
                                            <li>
                                                <i class="clip-attachment"></i> clip-attachment
                                            </li>
                                            <li>
                                                <i class="clip-attachment-2"></i> clip-attachment-2
                                            </li>
                                            <li>
                                                <i class="clip-eye"></i> clip-eye
                                            </li>
                                            <li>
                                                <i class="clip-eye-2"></i> clip-eye-2
                                            </li>
                                            <li>
                                                <i class="clip-windy"></i> clip-windy
                                            </li>
                                            <li>
                                                <i class="clip-bookmark"></i> clip-bookmark
                                            </li>
                                            <li>
                                                <i class="clip-bookmark-2"></i> clip-bookmark-2
                                            </li>
                                            <li>
                                                <i class="clip-brightness-high"></i> clip-brightness-high
                                            </li>
                                            <li>
                                                <i class="clip-brightness-medium"></i> clip-brightness-medium
                                            </li>
                                            <li>
                                                <i class="clip-star"></i> clip-star
                                            </li>
                                            <li>
                                                <i class="clip-star-2"></i> clip-star-2
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-3">
                                        <ul class="the-icons list-unstyled">
                                            <li>
                                                <i class="clip-star-3"></i> clip-star-3
                                            </li>
                                            <li>
                                                <i class="clip-star-4"></i> clip-star-4
                                            </li>
                                            <li>
                                                <i class="clip-star-5"></i> clip-star-5
                                            </li>
                                            <li>
                                                <i class="clip-star-6"></i> clip-star-6
                                            </li>
                                            <li>
                                                <i class="clip-heart"></i> clip-heart
                                            </li>
                                            <li>
                                                <i class="clip-thumbs-up"></i> clip-thumbs-up
                                            </li>
                                            <li>
                                                <i class="clip-thumbs-up-2"></i> clip-thumbs-up-2
                                            </li>
                                            <li>
                                                <i class="clip-cursor"></i> clip-cursor
                                            </li>
                                            <li>
                                                <i class="clip-stack-empty"></i> clip-stack-empty
                                            </li>
                                            <li>
                                                <i class="clip-question"></i> clip-question
                                            </li>
                                            <li>
                                                <i class="clip-notification"></i> clip-notification
                                            </li>
                                            <li>
                                                <i class="clip-notification-2"></i> clip-notification-2
                                            </li>
                                            <li>
                                                <i class="clip-question-2"></i> clip-question-2
                                            </li>
                                            <li>
                                                <i class="clip-plus-circle"></i> clip-plus-circle
                                            </li>
                                            <li>
                                                <i class="clip-plus-circle-2"></i> clip-plus-circle-2
                                            </li>
                                            <li>
                                                <i class="clip-minus-circle"></i> clip-minus-circle
                                            </li>
                                            <li>
                                                <i class="clip-minus-circle-2"></i> clip-minus-circle-2
                                            </li>
                                            <li>
                                                <i class="clip-info"></i> clip-info
                                            </li>
                                            <li>
                                                <i class="clip-info-2"></i> clip-info-2
                                            </li>
                                            <li>
                                                <i class="clip-cancel-circle"></i> clip-cancel-circle
                                            </li>
                                            <li>
                                                <i class="clip-cancel-circle-2"></i> clip-cancel-circle-2
                                            </li>
                                            <li>
                                                <i class="clip-checkmark-circle"></i> clip-checkmark-circle
                                            </li>
                                            <li>
                                                <i class="clip-checkmark-circle-2"></i> clip-checkmark-circle-2
                                            </li>
                                            <li>
                                                <i class="clip-close"></i> clip-close
                                            </li>
                                            <li>
                                                <i class="clip-close-2"></i> clip-close-2
                                            </li>
                                            <li>
                                                <i class="clip-close-3"></i> clip-close-3
                                            </li>
                                            <li>
                                                <i class="clip-checkmark"></i> clip-checkmark
                                            </li>
                                            <li>
                                                <i class="clip-checkmark-2"></i> clip-checkmark-2
                                            </li>
                                            <li>
                                                <i class="clip-close-4"></i> clip-close-4
                                            </li>
                                            <li>
                                                <i class="clip-wave"></i> clip-wave
                                            </li>
                                            <li>
                                                <i class="clip-wave-2"></i> clip-wave-2
                                            </li>
                                            <li>
                                                <i class="clip-arrow-up-left"></i> clip-arrow-up-left
                                            </li>
                                            <li>
                                                <i class="clip-arrow-up"></i> clip-arrow-up
                                            </li>
                                            <li>
                                                <i class="clip-arrow-up-right"></i> clip-arrow-up-right
                                            </li>
                                            <li>
                                                <i class="clip-arrow-right"></i> clip-arrow-right
                                            </li>
                                            <li>
                                                <i class="clip-arrow-down-right"></i> clip-arrow-down-right
                                            </li>
                                            <li>
                                                <i class="clip-arrow-down"></i> clip-arrow-down
                                            </li>
                                            <li>
                                                <i class="clip-arrow-down-left"></i> clip-arrow-down-left
                                            </li>
                                            <li>
                                                <i class="clip-arrow-left"></i> clip-arrow-left
                                            </li>
                                            <li>
                                                <i class="clip-arrow-up-left-2"></i> clip-arrow-up-left-2
                                            </li>
                                            <li>
                                                <i class="clip-arrow-up-2"></i> clip-arrow-up-2
                                            </li>
                                            <li>
                                                <i class="clip-arrow-up-right-2"></i> clip-arrow-up-right-2
                                            </li>
                                            <li>
                                                <i class="clip-arrow-right-2"></i> clip-arrow-right-2
                                            </li>
                                            <li>
                                                <i class="clip-arrow-down-right-2"></i> clip-arrow-down-right-2
                                            </li>
                                            <li>
                                                <i class="clip-arrow-down-2"></i> clip-arrow-down-2
                                            </li>
                                            <li>
                                                <i class="clip-arrow-down-left-2"></i> clip-arrow-down-left-2
                                            </li>
                                            <li>
                                                <i class="clip-arrow-left-2"></i> clip-arrow-left-2
                                            </li>
                                            <li>
                                                <i class="clip-arrow"></i> clip-arrow
                                            </li>
                                            <li>
                                                <i class="clip-arrow-2"></i> clip-arrow-2
                                            </li>
                                            <li>
                                                <i class="clip-arrow-3"></i> clip-arrow-3
                                            </li>
                                            <li>
                                                <i class="clip-arrow-4"></i> clip-arrow-4
                                            </li>
                                            <li>
                                                <i class="clip-arrow-up-3"></i> clip-arrow-up-3
                                            </li>
                                            <li>
                                                <i class="clip-arrow-right-3"></i> clip-arrow-right-3
                                            </li>
                                            <li>
                                                <i class="clip-arrow-down-3"></i> clip-arrow-down-3
                                            </li>
                                            <li>
                                                <i class="clip-arrow-left-3"></i> clip-arrow-left-3
                                            </li>
                                            <li>
                                                <i class="clip-checkbox-unchecked"></i> clip-checkbox-unchecked
                                            </li>
                                            <li>
                                                <i class="clip-checkbox"></i> clip-checkbox
                                            </li>
                                            <li>
                                                <i class="clip-checkbox-checked"></i> clip-checkbox-checked
                                            </li>
                                            <li>
                                                <i class="clip-checkbox-unchecked-2"></i> clip-checkbox-unchecked-2
                                            </li>
                                            <li>
                                                <i class="clip-square"></i> clip-square
                                            </li>
                                            <li>
                                                <i class="clip-checkbox-partial"></i> clip-checkbox-partial
                                            </li>
                                            <li>
                                                <i class="clip-checkbox-partial-2"></i> clip-checkbox-partial-2
                                            </li>
                                            <li>
                                                <i class="clip-checkbox-checked-2"></i> clip-checkbox-checked-2
                                            </li>
                                            <li>
                                                <i class="clip-checkbox-unchecked-3"></i> clip-checkbox-unchecked-3
                                            </li>
                                            <li>
                                                <i class="clip-radio-checked"></i> clip-radio-checked
                                            </li>
                                            <li>
                                                <i class="clip-radio-unchecked"></i> clip-radio-unchecked
                                            </li>
                                            <li>
                                                <i class="clip-circle"></i> clip-circle
                                            </li>
                                            <li>
                                                <i class="clip-circle-2"></i> clip-circle-2
                                            </li>
                                            <li>
                                                <i class="clip-new-tab"></i> clip-new-tab
                                            </li>
                                            <li>
                                                <i class="clip-popout"></i> clip-popout
                                            </li>
                                            <li>
                                                <i class="clip-embed"></i> clip-embed
                                            </li>
                                            <li>
                                                <i class="clip-code"></i> clip-code
                                            </li>
                                            <li>
                                                <i class="clip-seven-segment-0"></i> clip-seven-segment-0
                                            </li>
                                            <li>
                                                <i class="clip-seven-segment-1"></i> clip-seven-segment-1
                                            </li>
                                            <li>
                                                <i class="clip-seven-segment-2"></i> clip-seven-segment-2
                                            </li>
                                            <li>
                                                <i class="clip-seven-segment-3"></i> clip-seven-segment-3
                                            </li>
                                            <li>
                                                <i class="clip-seven-segment-4"></i> clip-seven-segment-4
                                            </li>
                                            <li>
                                                <i class="clip-seven-segment-5"></i> clip-seven-segment-5
                                            </li>
                                            <li>
                                                <i class="clip-seven-segment-6"></i> clip-seven-segment-6
                                            </li>
                                            <li>
                                                <i class="clip-seven-segment-7"></i> clip-seven-segment-7
                                            </li>
                                            <li>
                                                <i class="clip-seven-segment-8"></i> clip-seven-segment-8
                                            </li>
                                            <li>
                                                <i class="clip-seven-segment-9"></i> clip-seven-segment-9
                                            </li>
                                            <li>
                                                <i class="clip-share"></i> clip-share
                                            </li>
                                            <li>
                                                <i class="clip-google"></i> clip-google
                                            </li>
                                            <li>
                                                <i class="clip-google-plus"></i> clip-google-plus
                                            </li>
                                            <li>
                                                <i class="clip-facebook"></i> clip-facebook
                                            </li>
                                            <li>
                                                <i class="clip-twitter"></i> clip-twitter
                                            </li>
                                            <li>
                                                <i class="clip-feed"></i> clip-feed
                                            </li>
                                            <li>
                                                <i class="clip-youtube"></i> clip-youtube
                                            </li>
                                            <li>
                                                <i class="clip-youtube-2"></i> clip-youtube-2
                                            </li>
                                            <li>
                                                <i class="clip-vimeo"></i> clip-vimeo
                                            </li>
                                            <li>
                                                <i class="clip-flickr"></i> clip-flickr
                                            </li>
                                            <li>
                                                <i class="clip-picassa"></i> clip-picassa
                                            </li>
                                            <li>
                                                <i class="clip-dribbble"></i> clip-dribbble
                                            </li>
                                            <li>
                                                <i class="clip-forrst"></i> clip-forrst
                                            </li>
                                            <li>
                                                <i class="clip-deviantart"></i> clip-deviantart
                                            </li>
                                            <li>
                                                <i class="clip-steam"></i> clip-steam
                                            </li>
                                            <li>
                                                <i class="clip-github"></i> clip-github
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-3">
                                        <ul class="the-icons list-unstyled">
                                            <li>
                                                <i class="clip-github-2"></i> clip-github-2
                                            </li>
                                            <li>
                                                <i class="clip-wordpress"></i> clip-wordpress
                                            </li>
                                            <li>
                                                <i class="clip-blogger"></i> clip-blogger
                                            </li>
                                            <li>
                                                <i class="clip-tumblr"></i> clip-tumblr
                                            </li>
                                            <li>
                                                <i class="clip-yahoo"></i> clip-yahoo
                                            </li>
                                            <li>
                                                <i class="clip-tux"></i> clip-tux
                                            </li>
                                            <li>
                                                <i class="clip-apple"></i> clip-apple
                                            </li>
                                            <li>
                                                <i class="clip-finder"></i> clip-finder
                                            </li>
                                            <li>
                                                <i class="clip-android"></i> clip-android
                                            </li>
                                            <li>
                                                <i class="clip-windows"></i> clip-windows
                                            </li>
                                            <li>
                                                <i class="clip-windows8"></i> clip-windows8
                                            </li>
                                            <li>
                                                <i class="clip-soundcloud"></i> clip-soundcloud
                                            </li>
                                            <li>
                                                <i class="clip-skype"></i> clip-skype
                                            </li>
                                            <li>
                                                <i class="clip-reddit"></i> clip-reddit
                                            </li>
                                            <li>
                                                <i class="clip-linkedin"></i> clip-linkedin
                                            </li>
                                            <li>
                                                <i class="clip-lastfm"></i> clip-lastfm
                                            </li>
                                            <li>
                                                <i class="clip-stumbleupon"></i> clip-stumbleupon
                                            </li>
                                            <li>
                                                <i class="clip-stackoverflow"></i> clip-stackoverflow
                                            </li>
                                            <li>
                                                <i class="clip-pinterest"></i> clip-pinterest
                                            </li>
                                            <li>
                                                <i class="clip-xing"></i> clip-xing
                                            </li>
                                            <li>
                                                <i class="clip-foursquare"></i> clip-foursquare
                                            </li>
                                            <li>
                                                <i class="clip-paypal"></i> clip-paypal
                                            </li>
                                            <li>
                                                <i class="clip-paypal-2"></i> clip-paypal-2
                                            </li>
                                            <li>
                                                <i class="clip-libreoffice"></i> clip-libreoffice
                                            </li>
                                            <li>
                                                <i class="clip-file-pdf"></i> clip-file-pdf
                                            </li>
                                            <li>
                                                <i class="clip-file-openoffice"></i> clip-file-openoffice
                                            </li>
                                            <li>
                                                <i class="clip-file-word"></i> clip-file-word
                                            </li>
                                            <li>
                                                <i class="clip-file-excel"></i> clip-file-excel
                                            </li>
                                            <li>
                                                <i class="clip-file-zip"></i> clip-file-zip
                                            </li>
                                            <li>
                                                <i class="clip-file-powerpoint"></i> clip-file-powerpoint
                                            </li>
                                            <li>
                                                <i class="clip-file-xml"></i> clip-file-xml
                                            </li>
                                            <li>
                                                <i class="clip-file-css"></i> clip-file-css
                                            </li>
                                            <li>
                                                <i class="clip-html5"></i> clip-html5
                                            </li>
                                            <li>
                                                <i class="clip-css3"></i> clip-css3
                                            </li>
                                            <li>
                                                <i class="clip-chrome"></i> clip-chrome
                                            </li>
                                            <li>
                                                <i class="clip-firefox"></i> clip-firefox
                                            </li>
                                            <li>
                                                <i class="clip-IE"></i> clip-IE
                                            </li>
                                            <li>
                                                <i class="clip-opera"></i> clip-opera
                                            </li>
                                            <li>
                                                <i class="clip-safari"></i> clip-safari
                                            </li>
                                            <li>
                                                <i class="clip-IcoMoon"></i> clip-IcoMoon
                                            </li>
                                            <li>
                                                <i class="clip-fullscreen-exit-alt"></i> clip-fullscreen-exit-alt
                                            </li>
                                            <li>
                                                <i class="clip-fullscreen"></i> clip-fullscreen
                                            </li>
                                            <li>
                                                <i class="clip-fullscreen-alt"></i> clip-fullscreen-alt
                                            </li>
                                            <li>
                                                <i class="clip-fullscreen-exit"></i> clip-fullscreen-exit
                                            </li>
                                            <li>
                                                <i class="clip-transfer"></i> clip-transfer
                                            </li>
                                            <li>
                                                <i class="clip-left-quote"></i> clip-left-quote
                                            </li>
                                            <li>
                                                <i class="clip-right-quote"></i> clip-right-quote
                                            </li>
                                            <li>
                                                <i class="clip-heart-2"></i> clip-heart-2
                                            </li>
                                            <li>
                                                <i class="clip-study"></i> clip-study
                                            </li>
                                            <li>
                                                <i class="clip-wand"></i> clip-wand
                                            </li>
                                            <li>
                                                <i class="clip-zoom-in-2"></i> clip-zoom-in-2
                                            </li>
                                            <li>
                                                <i class="clip-zoom-out-2"></i> clip-zoom-out-2
                                            </li>
                                            <li>
                                                <i class="clip-search-3"></i> clip-search-3
                                            </li>
                                            <li>
                                                <i class="clip-user-6"></i> clip-user-6
                                            </li>
                                            <li>
                                                <i class="clip-users-3"></i> clip-users-3
                                            </li>
                                            <li>
                                                <i class="clip-archive"></i> clip-archive
                                            </li>
                                            <li>
                                                <i class="clip-keyboard-2"></i> clip-keyboard-2
                                            </li>
                                            <li>
                                                <i class="clip-paperclip"></i> clip-paperclip
                                            </li>
                                            <li>
                                                <i class="clip-home-3"></i> clip-home-3
                                            </li>
                                            <li>
                                                <i class="clip-chevron-up"></i> clip-chevron-up
                                            </li>
                                            <li>
                                                <i class="clip-chevron-right"></i> clip-chevron-right
                                            </li>
                                            <li>
                                                <i class="clip-chevron-left"></i> clip-chevron-left
                                            </li>
                                            <li>
                                                <i class="clip-chevron-down"></i> clip-chevron-down
                                            </li>
                                            <li>
                                                <i class="clip-error"></i> clip-error
                                            </li>
                                            <li>
                                                <i class="clip-add"></i> clip-add
                                            </li>
                                            <li>
                                                <i class="clip-minus"></i> clip-minus
                                            </li>
                                            <li>
                                                <i class="clip-alert"></i> clip-alert
                                            </li>
                                            <li>
                                                <i class="clip-pictures-2"></i> clip-pictures-2
                                            </li>
                                            <li>
                                                <i class="clip-atom-3"></i> clip-atom-3
                                            </li>
                                            <li>
                                                <i class="clip-eyedropper-2"></i> clip-eyedropper-2
                                            </li>
                                            <li>
                                                <i class="clip-warning"></i> clip-warning
                                            </li>
                                            <li>
                                                <i class="clip-expand"></i> clip-expand
                                            </li>
                                            <li>
                                                <i class="clip-clock-2"></i> clip-clock-2
                                            </li>
                                            <li>
                                                <i class="clip-target"></i> clip-target
                                            </li>
                                            <li>
                                                <i class="clip-loop"></i> clip-loop
                                            </li>
                                            <li>
                                                <i class="clip-refresh"></i> clip-refresh
                                            </li>
                                            <li>
                                                <i class="clip-spin-alt"></i> clip-spin-alt
                                            </li>
                                            <li>
                                                <i class="clip-exit"></i> clip-exit
                                            </li>
                                            <li>
                                                <i class="clip-enter"></i> clip-enter
                                            </li>
                                            <li>
                                                <i class="clip-locked"></i> clip-locked
                                            </li>
                                            <li>
                                                <i class="clip-unlocked"></i> clip-unlocked
                                            </li>
                                            <li>
                                                <i class="clip-arrow-5"></i> clip-arrow-5
                                            </li>
                                            <li>
                                                <i class="clip-music-3"></i> clip-music-3
                                            </li>
                                            <li>
                                                <i class="clip-droplet-3"></i> clip-droplet-3
                                            </li>
                                            <li>
                                                <i class="clip-credit"></i> clip-credit
                                            </li>
                                            <li>
                                                <i class="clip-phone-3"></i> clip-phone-3
                                            </li>
                                            <li>
                                                <i class="clip-phone-4"></i> clip-phone-4
                                            </li>
                                            <li>
                                                <i class="clip-map-2"></i> clip-map-2
                                            </li>
                                            <li>
                                                <i class="clip-clock-3"></i> clip-clock-3
                                            </li>
                                            <li>
                                                <i class="clip-calendar-2"></i> clip-calendar-2
                                            </li>
                                            <li>
                                                <i class="clip-calendar-3"></i> clip-calendar-3
                                            </li>
                                            <li>
                                                <i class="clip-pie"></i> clip-pie
                                            </li>
                                            <li>
                                                <i class="clip-airplane"></i> clip-airplane
                                            </li>
                                            <li>
                                                <i class="clip-tree-2"></i> clip-tree-2
                                            </li>
                                            <li>
                                                <i class="clip-sun"></i> clip-sun
                                            </li>
                                            <li>
                                                <i class="clip-bubble-paperclip"></i> clip-bubble-paperclip
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="widget">
                            ...
                            <div class="body icons">
                                <p>
                                    370 icons in pictographic font form. Add <code> .fa fa-* </code> class to <code> &lt;i&gt; </code> to display icon. Provided by
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="promobox">
                            ...
                            <p class="center">
                                <a href="javascript:;" class="btn btn-bricky">
                                    Contact Clip-One
                                </a>
                            </p>
                        </div>
